            ...
            <View style = { styles.menuItem }>
                ...
                <View style = { styles.itemContainer }>
                    <View style = {[ styles.sectionHeader, ( !this.props.item.editable &&  { paddingBottom: 10 } ) ]}>
                        { (this.props.item.editable)
                            ?
                                <TextInput autoFocus = {true} underlineColorAndroid = "transparent" value = { this.props.item.name } style = { styles.textInput } />
                            :
                    ...
                    <View>
                        ...
                        { (this.props.item.editable)
                            ?
                                <TextInput multiline = { true } underlineColorAndroid = "transparent" value = { this.props.item.description } style = { styles.otherInfoTextInput } />
                            :
                    ...
                    <View style = {[ styles.itemImagesWrapper ]}>
                        {
                            ...
                            (
                                <ItemImagePicker key = { index } image = { item } editable = { this.props.item.editable } parentID = { this.props.item.id } />
                            ))
