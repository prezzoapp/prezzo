...
export default class MenuItem extends Component {
  static propTypes = {
    ...
    addNewImageThumbnail: PropTypes.func.isRequired,
            ...
            <View style={styles.controlBtnsPanel}>
                {this.props.item.editable &&
                    <View style={styles.controlBtnsPanel}>
                        ...
                        <TouchableOpacity activeOpacity={0.6} style={styles.twoLineIconBtn} onPress={() => this.props.deleteMenuItem()}>
            ...
            <View style={styles.itemContainer}>
                <View style={[styles.sectionHeader, (!this.props.item.editable && { paddingBottom: 10 })]}>
                    ...
                    {!this.props.item.editable &&
                        <TouchableOpacity
                          activeOpacity={0.6}
                          onPress={() => this.props.editMenuItem()}>
                ...
                <View style={[styles.itemImagesWrapper]}>
                    ...
                    <TouchableOpacity style={styles.itemImagePickerBtn} onPress={() => this.props.addNewImageThumbnail()}>
