...
//
//     if(Platform.OS === 'ios') {
//       this.checkNetworkStatusIOS().then(isConnected => {
//         if(isConnected) {
//           this.hitAPI();
//         } else {
//           this.showAlert('Uh-oh!', 'Please, check your internet connection.', TIME_OUT);
//         }
//       });
//     } else {
...
//         this.props.pricing
//       ).then(() => {})
//         .catch(e => this.showAlert('Uh-oh!', e.message, TIME_OUT));
//     }).catch(err => this.showAlert('Uh-oh!', err.message, TIME_OUT));
//   }
//
