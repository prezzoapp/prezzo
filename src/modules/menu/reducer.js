...
//           return category.set(
//             'data',
//             new List([new Map({ items: category.get('items') })])
//           ).delete('items');
//         });
//       // newCategories = action.payload
//       //   .get('categories')
...
//         });
//
//         console.log(newCategories.toJS());
//
//       // newCategories = action.payload
//       //   .get('data')
//       //   .get('categories')
...
//       //     .get('categories')
//       //     .map(category => {
//       //       // return category.set('data', [{ items: category.get('data').toJS() }])
//       //       return category.set(
//       //         'data',
//       //         new List([new Map({ items: category.get('data') })])
//       //       );
//       //     });
//       //
//       //   return state.update('data', () =>
//       //     state.get('data').set('categories', newCategories)
//       //     )
//       //     .update('isBusy', () => false);
//       // }
//
